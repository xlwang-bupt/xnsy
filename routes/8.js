...
var textContent = fs.readFileSync('./public/uploads/8textContent', 'utf8');
...
router.get('/', function(req, res, next) {
  ...
  _(news).forEach(function(news) {
    if (news.page && news.page === '8') {
      newsTitles.push(news.title);
    }
  });
  res.render('8', { title: 'Express', newsTitles: newsTitles});var newsTitlesArray = _.chunk(newsTitles, 5);
  var pagesNumberAll = [];
  ...
  res.render('8', { title: '四川省教学质量成果申报',
